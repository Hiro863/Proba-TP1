...
model
{
  ...
  # Prior
  theta1 ~ dgamma(1/0.1, 0.1) # s = 1/beta
  theta2 ~ dgamma(1/0.1, 0.1) # s = 1/beta
} '
...
hist(model_run$BUGSoutput$sims.array[,1,"theta1"], main="", probability = TRUE, xlab="delt8a")
hist(model_run$BUGSoutput$sims.array[,1,"theta2"], main="", probability = TRUE, xlab="delt8a")
```
Give the histogram of the differences
```{r}
diff <-model_run$BUGSoutput$sims.array[,1,"theta2"] - model_run$BUGSoutput$sims.array[,1,"theta1"]
hist(diff, main="", probability = TRUE, xlab="delt8a")
```
